        ...
        <div className="flex flex-wrap gap-4 md:gap-5 w-full justify-center xl:justify-start">
            ...
            {activeAlerts.map((alert) => (
              ...
              >
                ...
                <div className="flex items-center justify-center">
                  <IoAlert
                    className={`size-6 ${alert.type === "blue" ? "text-[#007CEC] dark:text-[#38BDF8]" : "text-[#EE1C1C] dark:text-[#F87171]"}`}
                  />
                </div>
                <div className="flex flex-col items-start justify-center overflow-hidden">
                  <p
                    className={`text-xs font-semibold truncate w-full ${alert.type === "blue" ? "text-[#007CEC] dark:text-[#38BDF8]" : "text-[#EE1C1C] dark:text-[#F87171]"}`}
                  >
                    {alert.title}
                  </p>
                  <p
                    className={`font-bold text-[10px] cursor-pointer hover:underline ${alert.type === "blue" ? "text-[#007CEC] dark:text-[#38BDF8]" : "text-[#EE1C1C] dark:text-[#F87171]"}`}
                  >
                    {alert.link}
                  </p>
                </div>
          ...
          {activeAlerts.length === 0 && (
            <button
              ...
              className="text-sm text-blue-500 underline btn-hover"
            >
              Reset Alerts
            </button>
          )}
